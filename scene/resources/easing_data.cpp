...
void EasingData::set_easing(Ref<Easing> p_easing) {
	easing = p_easing;
}
...
void CubicBezierEasingData::_update() {
	...
	if (easing.is_null()) {
		set_easing(CubicBezierEasing::create(args[0], args[1], args[2], args[3]));
	} else {
