...
void EquationEasing::set_equation(EquationEasing::Equation p_equation) {
	equation = p_equation;
...
EquationEasing::Equation EquationEasing::to_equation(EquationEasing::TransitionType p_trans, EquationEasing::EaseType p_ease) {
	return static_cast<EquationEasing::Equation>(CLAMP(p_trans * 4 + p_ease - 3, 0, static_cast<int>(EquationEasing::EQ_MAX)));
}
...
EquationEasing::EquationEasing(EquationEasing::Equation p_equation) {
